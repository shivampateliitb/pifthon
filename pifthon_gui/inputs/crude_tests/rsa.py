...
def main():
    ...
    msgA = int(input("Message A :Number to be encrypted(less than n)"))
    msgReceiverA = [{"message":-1}, {"nonceA":-1}, {"nonceB":-1}]
    ...
    msgB = int(input("Message B :Number to be encrypted(less than n)"))
    msgReceiverB = [{"message":-1}, {"nonceA":-1}, {"nonceB":-1}]
    
    print("INITIAL DETAILS OF A : \n")
    print("MsgA : "+str(msgA)+" NonceA : "+str(Na)+"\n")
    print("INITIAL DETAILS OF B : \n")
    print("MsgB : "+str(msgB)+" NonceB : "+str(Nb)+"\n")
    #Communication begins
    print("1. A encrypts the msgA using public key of B \n")
    CipherA = encode(nb, eb, msgA) 
    ...
    msgReceiverB[1]["nonceA"] = DecryptedNa
    ...
    msgReceiverB[2]["nonceB"] = DecryptedNb
