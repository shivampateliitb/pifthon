...
def main():
    ...
    DecryptedNa = decode_B(nb, db, CipherNa)
    ...
    CipherNb = encode_A(na, ea, Nb)
    CipherNa = encode_A(na, ea, Na)
    ...
    DecryptedNa = decode_A(na, da, CipherNa)
    ...
    CipherNb = encode_B(nb, eb, Nb)
    DecryptedNb = decode_B(nb, db, CipherNb)
